...
const About: React.FC = () => {
  const sections = [
    ...
    {
      title: 'INSPIRATION',
      content: 'Drawing from the raw energy of skateboarding, the freedom of surfing, and the thrill of snow sports, 9thform captures the essence of action sports culture in every piece we create.',
    },
  ];
